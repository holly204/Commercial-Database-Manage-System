------ Li Huang  W1641460 
/*Display the number of active service contracts and the total revenue generated each month by these contracts.*/
...
spool 'D:\APP\Oracle\SQL\project\serviceContractTotal.html';

break ON REPORT;
COMPUTE COUNT SUM  OF feePerMonth on REPORT
...
-- Run the query
SELECT contractId,customerId,startDate,endDate,machineId,serviceType,feePerMonth from ServiceContract
where status = 'active';
spool off;
...
@'D:\APP\Oracle\SQL\project\serviceContractTotal.sql';
*/
